<%-- 
    Document   : quiz
    Created on : Mar 12, 2019, 7:21:35 PM
    Author     : RASHI
--%>
    ...
    <body>
        <%
            ...
            try{
                ...
                st.executeUpdate("insert into quanti_ques(ques,ans1,ans2,ans3,ans4,correct_ans)values('"+ques+"','"+ans1+"','"+ans2+"','"+ans3+"','"+ans4+"','"+correct+"')");
