<%-- 
    Document   : verbal_display
    Created on : Mar 23, 2019, 10:59:54 PM
    Author     : RASHI
--%>
...
<%@ page import="java.sql.*" %>
    ...
    <center>
        ...
        <%
            ...
            String s = "SELECT * FROM verbal_ques where id='1' ";
         ...
         %>  
          <%
            ...
            String s3 = "SELECT * FROM verbal_ques where id='4' ";
           ...
           // for(int j=0;j<1;j++)
            ...
            String s4 = "SELECT * FROM verbal_ques where id='5' ";
