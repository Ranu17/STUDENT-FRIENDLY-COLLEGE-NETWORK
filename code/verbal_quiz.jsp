<%-- 
    Document   : verbal_quiz
    Created on : Mar 22, 2019, 3:04:02 PM
    Author     : RASHI
--%>
    ...
    <body>
        <%
            ...
            try{
                ...
                st.executeUpdate("insert into verbal_ques(ques,ans1,ans2,ans3,ans4,correct_ans)values('"+ques+"','"+ans1+"','"+ans2+"','"+ans3+"','"+ans4+"','"+correct+"')");
